...
const Footer = () => {
  ...
  const footerLinks = {
    services: ["Individual Therapy", "Couples Counseling", "Family Therapy", "Child Psychology", "Group Therapy", "Online Sessions"],
    resources: ["Mental Health Tips", "Crisis Resources", "FAQ", "Insurance Info", "Privacy Policy", "Terms of Service"],
    contact: [{
      icon: Phone,
      text: "+63 XXX XXX XXXX",
      href: "tel:+63"
    }, {
      icon: Mail,
      text: "psychaveph.info@gmail.com",
      href: "mailto:psychaveph.info@gmail.com"
    }, {
      icon: MapPin,
      text: "Mindanao, Philippines",
      href: "#"
    }]
  };
  const socialLinks = [{
    icon: Facebook,
    href: "https://facebook.com/psychaveph",
    label: "Facebook"
  }, {
    icon: Instagram,
    href: "https://instagram.com/psychaveph",
    label: "Instagram"
  }, {
    icon: Linkedin,
    href: "https://linkedin.com/company/psychaveph",
    label: "LinkedIn"
  }];
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="flex space-x-4">
              {socialLinks.map(social => <a key={social.label} href={social.href} className="w-10 h-10 bg-brand-secondary/20 rounded-lg flex items-center justify-center hover:bg-brand-accent hover:text-brand-dark transition-all duration-300" aria-label={social.label}>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              {footerLinks.resources.map(resource => <li key={resource}>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {footerLinks.contact.map((contact, index) => <a key={index} href={contact.href} className="flex items-center space-x-3 text-brand-light hover:text-brand-accent transition-colors">
